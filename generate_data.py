...
# Расставлены приблизительно вдоль корпусов слева→направо — поправить по факту.
PIN = {
    7:  {"xPct": 29.0, "yPct": 40.0},
    8:  {"xPct": 41.0, "yPct": 30.0},
    9:  {"xPct": 57.0, "yPct": 25.0},
    10: {"xPct": 68.0, "yPct": 20.0},
}
